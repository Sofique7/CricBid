...
export const LiveBiddingBoard: React.FC = () => {
  ...
  return (
    <div className="flex flex-col space-y-6">
      ...
      <VoiceControlPanel onVoiceCommand={executeVoiceCommand} isHost={true} />
              ...
              >
                <div className="flex items-center justify-between mb-1.5">
                  <div className="flex items-center space-x-2 overflow-hidden">
                    ...
                    <span className={`text-xs font-bold text-[#F8FAFC] uppercase truncate ${isUser ? 'underline decoration-[#38BDF8]' : ''}`} title={t.name}>
                      {t.shortName} {isUser && '👤'}
                    </span>
                  </div>
                  {isCurrentBidder && (
                    <span
                      ...
                      style={{ backgroundColor: t.color, color: '#07111F' }}
                    >
                      BID
                    </span>
                  )}
